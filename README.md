...
* **Deadline Wiki & Final Submission:** Monday 14 October, 2024 @ 18:00 (start of Week 12)
* **Deadline Individual Self-Evaluation:** Friday 18 October, 2024 @ 18:00 (Week 12)
...
4. A filled [Project Certification & Contribution Form (FINAL)](https://forms.gle/GooDPeQfZtsTBCn88).
> :warning: Each member of the team should fill a separate certification form. Members who do not certify will not be marked and will be awarded zero marks.
...
15 marks for the code submission for your team (not the individual submission) and Wiki report For the self-evaluation, you should consider the following:
...
Technical contribution: which part code did you implement that was useful to your team; e.g. it was part of the tournament, it was useful for running comparisons, etc?
